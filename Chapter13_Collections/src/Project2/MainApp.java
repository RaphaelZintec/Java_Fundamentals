...
public class MainApp {
    ...
    //your friends
        ...
        allMyFriends.add(bobby);
        allMyFriends.add(melissa);
        allMyFriends.add(darla);
        allMyFriends.add(bert);
        allMyFriends.add(grandma);
        allMyFriends.add(fester);
        allMyFriends.add(anna);

    //Control
        System.out.println("\n\uD83D\uDFE1 OPDRACHT 1 \uD83D\uDFE1");
        ControlPostCard controlPostCard = new ControlPostCard(yourPostCardList, yourFriendsPostCardList, allMyFriends);
        controlPostCard.switchFriendDoublePostCard();

        System.out.println("\n\uD83D\uDFE1 OPDRACHT 2 \uD83D\uDFE1");
        controlPostCard.orderByCountries();

        System.out.println("\n\uD83D\uDFE1 OPDRACHT 3 \uD83D\uDFE1");
        controlPostCard.removeAllExtraCards();

        System.out.println("\n\uD83D\uDFE1 OPDRACHT 4 \uD83D\uDFE1");
        controlPostCard.shareCardsWithFriends();
    }
}
